                   ...
                   <div class="contact_page_blocks">
                       <div class="contact_page_block">
                           ...
                           <div class="contact_page_block_list">
                               <div class="contact_page_block_list_top">Ежедневно, круглосуточно</div>
                               <div class="contact_page_block_list_bottom">+7 (800) 333-19-84</div>
                           </div>
                           <div class="contact_page_block_list">
                               <div class="contact_page_block_list_top">Ежедневно, круглосуточно</div>
                               <div class="contact_page_block_list_bottom">+7 (495) 120-23-25</div>
                           </div>
                       </div>
                       <div class="contact_page_block">
                           <div class="contact_page_block_header">E-mail</div>
                           <div class="contact_page_block_list">
                               <div class="contact_page_block_list_top">Вопросы по розничным продажам</div>
                               <div class="contact_page_block_list_bottom"><a href="mailto:sale@ru-mi.com">sale@ru-mi.com</a></div>
                           </div>
                           <div class="contact_page_block_list">
